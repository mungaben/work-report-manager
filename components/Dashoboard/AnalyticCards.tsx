...
const AnalyticCards = () => {
    return (
        <div className=' w-full flex flex-row justify-between items-center'>
            <div className=' flex flex-row items-center justify-start bg-[#fafafafa] shadow-md rounded-md p-2'>
                <div>
                    <div>
                        <h3 className=' font-[14px] text-[#333333]/90  text-2xl '>
                            work completed
                        </h3>
                    </div>
                    <div>
                        <h1 className=' flex mx-5  text-[#333333]/50  ' >
                            5638
                        </h1>
                    </div>
            ...
            <div className=' flex flex-row items-center justify-start bg-[#fafafafa] shadow-md p-2 m-2 rounded-md'>
                <div>
                    <div>
                        <h3 className=' font-[14px] text-[#333333]/90  text-2xl '>
                            Target
